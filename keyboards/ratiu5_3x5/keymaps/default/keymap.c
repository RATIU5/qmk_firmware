...
enum custom_keycodes {
    VVV = KC_TRNS,
    XXX = KC_NO,
    LSFT_A = MOD_LSFT(KC_A),
    LCTL_R = MOD_LCTL(KC_R),
    LALT_S = MOD_LALT(KC_S),
    LGUI_T = MOD_LGUI(KC_T),
    RGUI_N = MOD_RGUI(KC_N),
    RALT_E = MOD_RALT(KC_E),
    RCTL_I = MOD_RCTL(KC_I),
    RSFT_O = MOD_RSFT(KC_O),
